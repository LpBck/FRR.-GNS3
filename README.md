...
**Free Range Routing**(FRR) - одно из них. Это пакет програмvного обеспечения для UNIX-подобных систем, в частности GNU/Linux и FreeBSD, обеспечивающий реализацию протоколов OSPF, RIP, BGP, IS-IS и многих других.
